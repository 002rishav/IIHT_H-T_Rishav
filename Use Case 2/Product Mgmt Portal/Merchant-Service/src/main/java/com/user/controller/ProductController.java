...
public class ProductController {
    ...
    @GetMapping(value="/api/v1/product", consumes = MediaType.ALL_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @PreAuthorize("hasRole('Merchant')")
    public Object getAllProducts(){
        return productServiceImpl.getAllProducts();
    }

    @PostMapping(value="/api/v1/product",consumes = MediaType.ALL_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    @PreAuthorize("hasRole('Merchant')")
    ...
    @PutMapping(value="/api/v1/product/{id}",consumes = MediaType.ALL_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    @PreAuthorize("hasRole('Merchant')")
    ...
    @DeleteMapping(value="/api/v1/product/{id}",consumes = MediaType.ALL_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    @PreAuthorize("hasRole('Merchant')")
